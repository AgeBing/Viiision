...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页
    ...
    <span class="c-gray en">&gt;</span> APP列表
    <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a>
</nav>
<div class="page-container">
    <div class="text-c"> 日期选择：
        ...
        <input type="text" class="input-text" style="width:250px" placeholder="输入APP名称" id="" name="">
        <a href="/admin/selectByAppName"class="btn btn-primary radius"><i class="Hui-iconfont">&#xe665;</i> 搜APP</a>
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            ...
            <a href="/excel/apps_import" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 导入文件</a>
        </span>
        <span class="r">共有数据：<strong>{{count($apps)}}</strong> 条</span>
    </div>
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            @foreach($apps as $app)
                <tr class="text-c">
                    ...
                    <td>{{$app->app_name}}</td>
                    <td>{{$app->app_platform}}</td>
                    <td>{{$app->app_download_count}}</td>
                    <td>{{$app->app_comment_count}}</td>
                    <td>{{$app->app_date}}</td>
                    {{--<td class="td-manage">--}}
