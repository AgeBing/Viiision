...
@section('content')
    {{--form的id传给js--}}
    <form class="form form-horizontal" id="form-app_category-add"action="/admin/user/save">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>id：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="user_sex" datatype="*"  name="User[user_id]"nullmsg="不能为空">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="user_sex" datatype="*"  name="User[user_class]"nullmsg="不能为空">
            </div>
        </div>
        <div class="row cl">
