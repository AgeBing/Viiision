...
def get_downloadCount_to_mysql(appname,startMon,startDay,endMon,endDay):
    ...
    # # beforeDay = today - datetime.timedelta(days = days)
    # # startDate = beforeDay.strftime('%Y-%m-%d')
    # # print(endDate)
    # # print(startDate)
...
def get_info_to_mysql(appname,startMon,startDay,endMon,endDay):
    # Connect to the database
    connection = pymysql.connect(host='115.159.202.238',
                                 user='revuser',
                                 port=3306,
...
appname = 'faceu'
print("*********** Info ************")
get_info_to_mysql(appname,4,1,4,14)
print("*********** download ************")
get_downloadCount_to_mysql(appname,4,1,4,14)
